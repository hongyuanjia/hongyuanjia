...
[epwshiftr](https://ideas-lab-nus.github.io/epwshiftr/) is a free, open-source
[R](https://www.r-project.org/) package for adapting
[EnergyPlus](https://energyplus.net/) Weather (EPW) files to incorporate
climate change predictions using the morphing method. The focus of this package
is to automatically process big amounts of climate change model data from the
latest [CMIP6](https://www.wcrp-climate.org/wgcm-cmip/wgcm-cmip6) GCMs (Global
Climate Models) and create future EPW files for world-wide locations in a
user-friendly and flexible way. It is capable of processing multiple GCM
outputs at various spatial and temporal resolutions. The package is designed
into a modularity style. Each module stores data in a standard data format,
which allows to explore a considerably broad pool of ready-to-use methods
available in R for customized statistical analysis. Most
computational-intensive processes have been designed to run in parallel for
speed-up.
...
* epwshiftr online manual: https://ideas-lab-nus.github.io/epwshiftr/
